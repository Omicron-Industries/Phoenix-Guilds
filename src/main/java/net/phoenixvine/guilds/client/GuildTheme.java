...
public class GuildTheme {
    ...
    public static void setCurrent(String name) {
        ...
        if (t == null) {
            ...
            if (t != null) {
                name = upperName; // Standardize capitalization mapping
            }
        }
        ...
        if (t != null) {
            active = t;
            activeName = name;
            // CRITICAL: Rebuild the primitive cache variables immediately
    ...
    public static void saveCustomTheme(String name, GuildTheme theme) {
        ...
        // If updating the active theme parameters, refresh immediately
    ...
    public static boolean deleteCustom(String name) {
        ...
        // CRITICAL: Rebuild primitive cache in case active fallbacks altered colors
        GuildThemeUtils.refreshCache();
        return true;
    }
    ...
    public static void loadThemes() {
        ...
        // CRITICAL: Initialize the flat rendering cache variables for first load!
        GuildThemeUtils.refreshCache();
    }
}
